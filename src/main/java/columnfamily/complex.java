...
public class complex {
    ...
    static int count=0;
    public String createForComplex(Adat a, AdatRelationships [] ar, AdatAttributeRelationships [] adatAtrRel, MultiLevelPan mlp, MultiLevelAdat mla){
        ...
        for(Adat child: children){
            ...
            complex childClass = new complex();
          ...
          //   String child_cf = child.getName();
           ...
           // Hbase_col[len++] = cf +":"+child_cf+"_Key";
            ...
            if (!(tree.get(child).isEmpty())){
                createForComplex(child, ar, adatAtrRel, mlp, mla); 
               // childClass.CassandraList.put(childAdatKey, "Bigint");
            }
        }              
