...
public class AdatAttributeRelationships {
    ...
    HashMap<ArrayList, Integer> cardinality;
    HashMap<ArrayList, Boolean> applicability;
  
    public AdatAttributeRelationships(HashMap<ArrayList,Boolean> isAdditive
            , HashMap<ArrayList, Integer> cardinality, HashMap<ArrayList, Boolean> applicability) {             
    ...
    public HashMap<ArrayList, Integer> getCardinality(){
